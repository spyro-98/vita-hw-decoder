#ifndef VITA_HW_DECODER_AAC_DECODER_H
#define VITA_HW_DECODER_AAC_DECODER_H
...
int vita_hw_aac_decoder_init(VitaAacDecoder *dec, uint32_t channels, uint32_t sample_rate);
...
int vita_hw_aac_decoder_init_ex(VitaAacDecoder *dec, uint32_t channels,
...
int vita_hw_aac_decoder_decode(VitaAacDecoder *dec, const uint8_t *es_data,
                            size_t es_size, VitaAacDecodedAudio *out);

void vita_hw_aac_decoder_term(VitaAacDecoder *dec);

#endif /* VITA_HW_DECODER_AAC_DECODER_H */
